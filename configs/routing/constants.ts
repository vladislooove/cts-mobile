...
export const RISK_ASSESSMENT_SCREEN = 'RISK_ASSESSMENT_SCREEN';
export const RESULTS_SCREEN = 'RESULTS_SCREEN';
export const RESOURCES_CATEGORY_SCREEN = 'RESOURCES_CATEGORY_SCREEN';
export const RESOURCE_SCREEN = 'RESOURCE_SCREEN';
